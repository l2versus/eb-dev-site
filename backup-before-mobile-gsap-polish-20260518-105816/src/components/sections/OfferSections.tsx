        ...
        <div className="relative mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-12">
          ...
          <div className="package-grid mt-12 grid gap-5 lg:grid-cols-3">
            {packages.map((pack, index) => (
              <article
                key={pack.name}
                className="package-card flex min-h-[560px] flex-col border border-[#f5f0e6]/12 bg-[#151411]/90 p-6 shadow-[0_28px_100px_rgba(0,0,0,0.36)] backdrop-blur-xl will-change-transform"
              >
